...
<html>
<head>
<title>Launch Page: Shaquan Character Generator</title>
...
<body>
	...
	<section>
        ...
        <br/>
            ...
            <br/>    
			<form action="" id ="shaquanForm"  target="_blank" method="post">
		...
		<div class="content8">
			  ...
			  <select id="level" class="dropdownmenu2Iconic">
				<option value="01" selected>Shaquan, Level 1</option>
				<option value="02">Shaquan, Level 2</option>
				<option value="03">Shaquan, Level 3</option>
				<option value="04">Shaquan, Level 4</option>
				<option value="05">Shaquan, Level 5</option>
				<option value="06">Shaquan, Level 6</option>
				<option value="07">Shaquan, Level 7</option>
				<option value="08">Shaquan, Level 8</option>
				<option value="09">Shaquan, Level 9</option>
				<option value="10">Shaquan, Level 10</option>
			  </select>
        ...
        {
            $("#shaquanForm").attr('action', "shaquan/shaquan"+ $("#level").val() +  ".php");
        });
